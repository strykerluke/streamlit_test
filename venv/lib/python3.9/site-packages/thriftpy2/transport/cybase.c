 ...
 */
    __pyx_t_8 = PyObject_Length(__pyx_v_new_data); if (unlikely(__pyx_t_8 == ((Py_ssize_t)-1))) __PYX_ERR(1, 62, __pyx_L1_error)
 ...
 */
      __pyx_t_8 = PyObject_Length(__pyx_v_more); if (unlikely(__pyx_t_8 == ((Py_ssize_t)-1))) __PYX_ERR(1, 66, __pyx_L1_error)
      __pyx_t_3 = PyInt_FromSsize_t(__pyx_t_8); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 66, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
 ...
 */
    __pyx_t_9 = __Pyx_PyObject_AsWritableString(__pyx_v_new_data); if (unlikely((!__pyx_t_9) && PyErr_Occurred())) __PYX_ERR(1, 76, __pyx_L1_error)
 ...
 * 
 */
    (void)(memcpy(((__pyx_v_self->buf + __pyx_v_self->cur) + __pyx_v_self->data_size), ((char *)__pyx_t_9), __pyx_v_new_data_len));
